(function() {/*
    ...
    */
    var newSul = []; 
    newSul = brasil.filter(function(item) {
        return brasil.indexOf(item);
    });
    ...
    */
    ...
    brasil.forEach(function(item, index) {
        if (sudeste.indexOf(item) > -1) {
            newSudeste.push(brasil.splice(index, index))
        }
    });
    ...
    */
    ...
    var every = teste === false ? 'Nem todos os estados tem mais de 7 letras!' : 'Sim, todos os estados tem mais de 7 letras!';
    console.log(every)
    ...
    */
    ...
    var validacaoCeara = brasil.indexOf('Ceara') > -1 ? 'Ceará está incluído!' : 'Ceará não foi incluído :(';
    console.log(validacaoCeara)
    ...
    */
    var map = [];
    map = newBrasil.map(function(item) {
