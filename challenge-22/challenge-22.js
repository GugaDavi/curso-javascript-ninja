  (function (win, doc) {
    ...
    */
    ...
    console.log( getFullName.call( matheus ) );
    ...
    */
    ...
    var sum = function sum() {
      ...
      var result = Array.prototype.reduce.call( arguments, function( acomulado, atual ) {
    ...
    */
    ...
    console.log( sum( 4, 7, 8, 9, 5 ) );
    console.log( sum( 12, 4, 9, 56, -30 ) );
