(function () {
    ...
    */
    ...
    var testeOperador = isOperatorValid;
    var erroOperador;

    function calculator(sinal) {
        if (!testeOperador(sinal)) {
            erroOperador = sinal;
            return false;
        }
        return function (x, y) {
    ...
    */
    ...
    function showErrorMessage(erroOperador) {
        return 'Operação "' + erroOperador + '" não permitida!';
    }
    ...
    */
    ...
    number1 = 10;
    number2 = 7;
    console.log(showOperationMessage(operationSignal, number1, number2), !!sum ? sum(number1, number2) : showErrorMessage(erroOperador));
    // A operação 10 + 7 =  17
    ...
    */
    ...
    console.log(showOperationMessage(operationSignal, number1, number2), !!subtraction ? subtraction(number1, number2) : showErrorMessage(erroOperador));
    // A operação 10 - 7 =  3
    operationSignal = '*';
    var multiplication = calculator(operationSignal);
    console.log(showOperationMessage(operationSignal, number1, number2), !!multiplication ? multiplication(number1, number2) : showErrorMessage(erroOperador));
    // A operação 10 * 7 =  70
    operationSignal = '/';
    var division = calculator(operationSignal);
    console.log(showOperationMessage(operationSignal, number1, number2), !!division ? division(number1, number2) : showErrorMessage(erroOperador));
    // A operação 10 / 7 =  1.4285714285714286
    operationSignal = '%';
    var mod = calculator(operationSignal);
    console.log(showOperationMessage(operationSignal, number1, number2), !!mod ? mod(number1, number2) : showErrorMessage(erroOperador));
    // A operação 10 % 7 =  3
    ...
    */
    ...
    console.log(showOperationMessage(operationSignal, number1, number2), !!erro ? erro(number1, number2) : showErrorMessage(erroOperador));
    // A operação 10 a 7 =  Operação "a" não permitida!
