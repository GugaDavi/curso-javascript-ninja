(function () {
    ...
    */
    ...
    var hasClass = function hasClass( markup, cssClass ) {
        var correctCssClass = new RegExp( 'class=["\'](\\w+\\W+)?' + cssClass );
        return correctCssClass.test( markup );
    };

    var cssClass = [ "container", "text", "date", "excerpt", "main" ];

    cssClass.forEach( function ( cssClass ) {
