(function (win, doc){
    ...
    */
    ...
    console.log( 'Bem vindo ' + (( username === null) ? 'Desconhecido': username) + '!' );
    ...
    */
    ...
    var $message = doc.querySelector( '[cols="30"]' )
    ...
    */
    ...
    $button.addEventListener( 'click', function (event) {
        ...
        if ( confirm( 'Tem certeza que deseja enviar o formulário?' ) ) {
            ...
            } else if ( isValidEmail( $inputEmail.value ) === false && $inputEmail.value !== null ) {
