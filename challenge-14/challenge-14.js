(function () {
    ...
    */
    ...
    var justMod2Or3 = justNumbers.filter(function(element){
    ...
    */
    ...
    var nameLess = name.reduce(function (acumulado, atual) {
    ...
    */
    ...
    console.log('\nA resposta das ultimas duas questões acima estão "erradas" justamente porque usando o {number: 2} no momento que fazemos a validação, criamos um novo objeto, logo ele não existirá no array original')
