(function () {
    ...
    */
    ...
    console.log( text.replace( /Manuel Marques de Sousa/, 'Gustavo Davi de Melo Guedes' ) );
    ...
    */
    ...
    console.log( text.replace( /brasileiro/, 'maceioense' ) );
    ...
    */
    ...
    console.log( text.replace( /(O Centauro de Luvas)/, function( fullCapt, letter1 ) {
