(function () {
    ...
    */
    ...
    var correctCPF =  /(\d{3})(\d{3})(\d{3})(\d{2})/g;

    var functionCorrectCPF = function ( regex, cpf1, cpf2, cpf3, cpf4 ) {
        return cpf1 + '.' + cpf2 + '.' + cpf3 + '-' + cpf4;
    };
    
    console.log( cleanCPF( '049-214 3421-1' ).replace( correctCPF, functionCorrectCPF ) ); 
    console.log( cleanCPF( '210.458.522-05' ).replace( correctCPF, functionCorrectCPF ) ); 
    console.log( cleanCPF( '735 500 794 - 22' ).replace( correctCPF, functionCorrectCPF ) ); 
    console.log( cleanCPF( '101.123-131x32' ).replace( correctCPF,functionCorrectCPF ) ); 
    ...
    */
    ...
    var Jun_And_Jul = /ju\w+/g;

    console.log( 'Os meses de janeiro, junho e julho começam com a letra j.'.match( Jun_And_Jul ) );
    ...
    */
    ...
    var frase = '<div><section><blockquote>Texto <img /></blockquote></section></div>';
    ...
    */
    ...
    console.log( text.replace( regexText, '<$1>O texto dentro da tag "$1" é "$2"<$3>\n' ) );
